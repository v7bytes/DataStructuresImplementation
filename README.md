...
```sh
$ git clone https://github.com/Your_Name/DataStructuresImplementation.git
```
...
```sh
$ git remote -v
origin  https://github.com/Your_Name/DataStructuresImplementation.git (fetch)
...
Once you have completed these steps, you are ready to start contributing by checking our `Good First Issue` Issues and creating [pull requests](https://github.com/SubratYeeshu/DataStructuresImplementation/pulls).
